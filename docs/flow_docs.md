...
- Only the order owner can access their orders.
- Pending orders can be cancelled.
- The total price is calculated based on the order items and their quantities.
- Payment processing is a placeholder and needs to be implemented.
```
